...
describe('setUTCWeek', function () {
  it('sets the local week', function () {
    var result = (0, _2.default)(new Date(Date.UTC(2005, 0 /* Jan */, 2)), 1);
    _powerAssert2.default.deepEqual(result, new Date(Date.UTC(2004, 11 /* Dec */, 26)));
  });

  it('accepts a timestamp', function () {
    var result = (0, _2.default)(Date.UTC(2009, 11 /* Dec */, 2), 1);
    _powerAssert2.default.deepEqual(result, new Date(Date.UTC(2008, 11 /* Dec */, 31)));
  });

  it('converts a fractional number to an integer', function () {
    var result = (0, _2.default)(new Date(Date.UTC(2005, 0 /* Jan */, 2)), 1.1);
    _powerAssert2.default.deepEqual(result, new Date(Date.UTC(2004, 11 /* Dec */, 26)));
  });
  ...
  it('allows to specify `weekStartsOn` and `firstWeekContainsDate` in locale', function () {
    ...
    var result = (0, _2.default)(date, 1, {
      locale: {
        options: { weekStartsOn: 1, firstWeekContainsDate: 4 }
      }
    });
    _powerAssert2.default.deepEqual(result, new Date(Date.UTC(2004, 0 /* Jan */, 4)));
  });
  ...
  it('throws `RangeError` if `options.weekStartsOn` is not convertable to 0, 1, ..., 6 or undefined', function () {
    var block = _2.default.bind(null, new Date(2004, 7 /* Aug */, 7), 53, {
      weekStartsOn: NaN
    });
