...
describe('getUTCWeekYear', function () {
  it('returns the local week-numbering year of the given date', function () {
    var result = (0, _2.default)(new Date(Date.UTC(2004, 11 /* Dec */, 26)));
    (0, _powerAssert2.default)(result === 2005);
  });

  it('accepts a timestamp', function () {
    var result = (0, _2.default)(Date.UTC(2000, 11 /* Dec */, 30));
    (0, _powerAssert2.default)(result === 2000);
  });
