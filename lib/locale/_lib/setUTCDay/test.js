...
describe('setUTCDay', function () {
  ...
  context('the day index is more than 6', function () {
    ...
    it('allows to specify which day is the first day of the week', function () {
      ...
      _powerAssert2.default.deepEqual(result, new Date(Date.UTC(2014, 8 /* Sep */, 14)));
    });

    it('sets the day of another week in the future', function () {
      var result = (0, _2.default)(new Date(Date.UTC(2014, 8 /* Sep */, 1)), 14, {
        weekStartsOn: 1
      });
  ...
  context('the day index is less than 0', function () {
    it('sets the day of the last week', function () {
      var result = (0, _2.default)(new Date(Date.UTC(2014, 8 /* Sep */, 1)), -6);
      _powerAssert2.default.deepEqual(result, new Date(Date.UTC(2014, 7 /* Aug */, 25)));
    });
    ...
    it('set the day of another week in the past', function () {
      ...
      _powerAssert2.default.deepEqual(result, new Date(Date.UTC(2014, 7 /* Aug */, 24)));
    });
  });
  ...
  it('converts a fractional number to an integer', function () {
    var result = (0, _2.default)(new Date(Date.UTC(2014, 8 /* Sep */, 1)), 0.9);
    _powerAssert2.default.deepEqual(result, new Date(Date.UTC(2014, 7 /* Aug */, 31)));
  });
  ...
  it('returns `Invalid Date` if the given date is invalid', function () {
    var result = (0, _2.default)(new Date(NaN), 0);
  ...
  it('throws `RangeError` if `options.weekStartsOn` is not convertable to 0, 1, ..., 6 or undefined', function () {
    var block = _2.default.bind(null, new Date(2014, 8 /* Sep */, 1), 0, {
      weekStartsOn: NaN
    });
